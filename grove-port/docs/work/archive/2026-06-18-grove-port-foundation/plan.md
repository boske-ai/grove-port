...
- [x] Spec published in `spec/v1/`
- [x] `grove-port verify` passes on Boske-generated fixture
- [x] `grove-port convert --from chatgpt` produces valid package
- [x] `inspect` shows honest partial counts for ChatGPT import (schema + actual_counts in JSON)
- [x] MIT LICENSE on all packages
- [x] README links three layers + online converter (planned)
